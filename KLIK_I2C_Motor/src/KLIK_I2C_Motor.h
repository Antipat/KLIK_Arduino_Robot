...
#endif																																		//
																																			//
#include		"KLIK_I2C_Motor_I2C.h"																									//	Подключаем библиотеку выбора реализации шины I2C.
																																			//
...
#endif																																		//
																																			//
class KLIK_I2C_Motor{																													//
	public:																																	//
	/**	Конструктор класса **/																												//
		KLIK_I2C_Motor							(uint8_t address=0){																	//	Конструктор класса													(Параметр: адрес модуля на шине I2C, если не указан (=0), то адрес будет определён).
